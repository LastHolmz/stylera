...
export default function ProjectsHeroSection({
  ...
  return (
    <InViewSection
      className={`md:pt-32 mt-6 pb-20 px-4 md:ps-20`}
    ...
    >
      <Div className="max-w-7xl">
        ...
        {/* CTA Buttons */}
        <Div className={`flex flex-col gap-4`} variants={textVariants}>
          <Link
            href="https://wa.me/218928666458"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className="px-6  block py-3 rounded-full cursor-pointer bg-green-600 hover:bg-green-700 text-white transition">
