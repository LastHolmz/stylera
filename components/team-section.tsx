  ...
  const teamMembers = [
    {
      ...
      position: language === "ar" ? "المدير التنفيذي ومطور الواجهات الأمامية" : "CEO & Frontend Developer",
    ...
    },
    {
      ...
      position: language === "ar" ? "مطورة الواجهات الخلفية" : "Backend Developer",
    ...
    },
    {
      ...
      position: language === "ar" ? "مطورة تطبيقات الجوال" : "Mobile App Developer",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className={`max-w-3xl mx-auto mb-20 text-center`}>
          <h2 className="text-4xl md:text-5xl font-light text-white mb-6">
            <span className="font-medium instrument text-accent">{t("team.title")}</span>
          </h2>
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className={`${language === "ar" ? "text-right" : "text-left"}`}>
                ...
                <p className="text-white/70 text-sm font-light leading-relaxed mb-6">{member.bio}</p>
